Hi 👋 My name is Yulia Pershina
===============================

Junior Python Developer
-----------------------

I'm a beginner Python developer with a passion for learning. After completing my Python developer course at Hexlet, I've got solid grasp on both basic and advanced Python concepts, OOP, and SQL. My hands-on projects involved building web apps with Django and Flask, working with databases, and using Git for version control. I'm constantly expanding my skills and I'm eager to apply them in a real-world setting. Looking for either a junior Python developer role or internship!
